...
public:
	...
	// STUDENT MODIFICATION: Added functions to load textures, define materials, and set up lighting
	...
	// STUDENT MODIFICATION: Reorganized the code into functions to render each object
	void RenderBackdrop();
	void RenderLamp();
	void RenderCandle();
	void RenderMarbleSphere();
	void RenderInkPen();
};