...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// STUDENT MODIFICATION: this callback is used to receive mousewheel scroll events
...
// STUDENT MODIFICATION: Added mousewheel scroll callback
/***********************************************************
 *  Mouse_Wheel_Callback()
 *
 *  This method is automatically called from GLFW whenever
 *  the mousewheel is scrolled.
 ***********************************************************/
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// STUDENT MODIFICATION: if the camera object is null, then exit this method
	if (NULL == g_pCamera)
	{
		return;
	}

	// STUDENT MODIFICATION: add code to process camera panning up and down
	...
	// STUDENT MODIFICATION: process camera zooming in and out
	...
	// STUDENT MODIFICATION: process camera panning left and right
	...
	// STUDENT MODIFICATION: change between different projection views
...
void ViewManager::PrepareSceneView()
{
	...
	// STUDENT MODIFICATION: define the current projection matrix
